...
const ProfilePage = () => {
  ...
  return (
    <div>
      <div className="container w-full md:w-2xl lg:max-w-lg bg-secondary p-5 md:p-10 rounded-lg flex flex-col items-center justify-center gap-5 mb-10 mt-10 md:mt-0 lg:mt-10 xl:mt-0">
